...
export default function TransactionListPage() {
  // Hämta parametrar från "transactions/route.tsx"
  ...
  // Hook för att hämta alla transaktioner för detta konto
  const {
    data: transactions = [],
    isLoading,
    isError,
    error,
  } = useTransactions(cid, aid);
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-end">
        <button
          onClick={() =>
            navigate({
              to: `/clients/${cid}/accounts/${aid}/transactions/new`,
            })
          }
          ...
          {transactions.map((tx: TransactionDTO) => (
            ...
            >
              ...
              <button
                onClick={() =>
                  navigate({
                    to: `/clients/${cid}/accounts/${aid}/transactions/${tx.id}`,
                  })
                }
