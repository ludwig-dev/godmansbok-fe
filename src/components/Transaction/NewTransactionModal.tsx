// src/components/Transactions/NewTransactionModal.tsx
...
interface NewTransactionModalProps {
  ...
  accountId: number;
  onClose: () => void;
  onCreated: (newTx: TransactionDTO) => void;
}
...
export default function NewTransactionModal({
  ...
  const createTx = useCreateTransaction(clientId, accountId);
  ...
  return (
    <div className="space-y-4">
      <h3 className="text-xl font-semibold text-gray-800">Ny transaktion</h3>
